<div wire:init="loadPost">
    ...
    <x-table>
        <div class="px-6 py-4 flex items-center">
            ...
            <x-jet-input type="text" wire:model='search' class="mr-2 flex-1 "
                placeholder="Escribe el post a buscar..." />
            ...
            <tbody class="text-sm divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 focus-within:bg-gray-100">
                    ...
                    <td class="p-2 flex">
                        ...
                        <button wire:loading.attr="disabled" class="btn btn-blue mr-2"
                            wire:click.prefetch="edit({{$item}})">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button wire:loading.attr="disabled" class="btn btn-red" wire:click="$emit('deletePost', {{$item}})">
